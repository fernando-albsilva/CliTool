            ...
            new ToolArg
            {
                ...
                Commands = new List<CommandInfo>
                {
                    new CommandInfo
                    {
                        ...
                        Description = "Seleciona todos os registros da tabela employees"
                    },
                    new CommandInfo
                    {
                        Name = "SELECT first_name, last_name FROM employees WHERE department_id = 10;",
                        Description = "Filtra colunas específicas com condição no WHERE"
                    },
                    new CommandInfo
                    {
                        Name = "SELECT COUNT(*) FROM employees;",
                        Description = "Conta o número total de registros em uma tabela"
                    },
                    new CommandInfo
                    {
                        Name = "SELECT DISTINCT department_id FROM employees;",
                        Description = "Retorna valores únicos de uma coluna (sem duplicações)"
                    },
                    new CommandInfo
                    {
                        Name = "SELECT * FROM employees ORDER BY salary DESC;",
                        Description = "Ordena os resultados por salário em ordem decrescente"
                    },
                    new CommandInfo
                    {
                        Name = "SELECT * FROM employees WHERE hire_date BETWEEN '01-JAN-2020' AND '31-DEC-2020';",
                        Description = "Filtra registros com base em um intervalo de datas"
                    },
                    new CommandInfo
                    {
                        Name = "INSERT INTO departments (department_id, department_name) VALUES (280, 'INNOVATION');",
                        Description = "Insere um novo registro na tabela departments"
                    },
                    new CommandInfo
                    {
                        Name = "UPDATE employees SET salary = salary * 1.10 WHERE department_id = 50;",
                        Description = "Atualiza salários em 10% para um departamento específico"
                    },
                    new CommandInfo
                    {
                        Name = "DELETE FROM employees WHERE employee_id = 999;",
                        Description = "Remove um registro específico da tabela employees"
                    },
                    new CommandInfo
                    {
                        Name = "CREATE TABLE projects (id NUMBER PRIMARY KEY, name VARCHAR2(100));",
                        Description = "Cria uma nova tabela chamada projects com chave primária"
                    },
                    new CommandInfo
                    {
                        Name = "ALTER TABLE employees ADD (bonus NUMBER DEFAULT 0);",
                        Description = "Adiciona uma nova coluna chamada bonus com valor padrão 0"
                    },
                    new CommandInfo
                    {
                        Name = "DROP TABLE temp_data;",
                        Description = "Exclui permanentemente a tabela temp_data"
                    },
                    new CommandInfo
                    {
                        Name = "SELECT department_id, AVG(salary) FROM employees GROUP BY department_id;",
                        Description = "Agrupa registros por departamento e calcula o salário médio"
                    },
                    new CommandInfo
                    {
                        Name = "SELECT e.first_name, d.department_name FROM employees e JOIN departments d ON e.department_id = d.department_id;",
                        Description = "Realiza um INNER JOIN entre employees e departments"
                    },
                    new CommandInfo
                    {
                        Name = "SELECT e.first_name, NVL(e.commission_pct, 0) FROM employees e;",
                        Description = "Substitui valores nulos de commission_pct por 0 (NVL)"
                    },
                    new CommandInfo
                    {
                        Name = "SELECT SYSDATE FROM dual;",
                        Description = "Retorna a data e hora atuais do sistema Oracle"
                    },
                    new CommandInfo
                    {
                        Name = "SELECT employee_id, salary, ROWNUM FROM employees WHERE ROWNUM <= 5;",
                        Description = "Retorna os 5 primeiros registros da tabela employees"
                    },
                    new CommandInfo
                    {
                        Name = "SELECT * FROM (SELECT * FROM employees ORDER BY salary DESC) WHERE ROWNUM <= 3;",
                        Description = "Seleciona os 3 funcionários com maior salário"
                    },
                    new CommandInfo
                    {
                        Name = "DESCRIBE employees;",
                        Description = "Exibe a estrutura da tabela employees (nome, tipo e tamanho das colunas)"
                    },
                    new CommandInfo
                    {
                        Name = "COMMIT;",
                        Description = "Confirma as alterações realizadas na transação atual"
                    },
                    new CommandInfo
                    {
                        Name = "ROLLBACK;",
                        Description = "Desfaz todas as alterações realizadas desde o último COMMIT"
                    },
                    new CommandInfo
                    {
                        Name = "CREATE INDEX idx_emp_salary ON employees(salary);",
                        Description = "Cria um índice na coluna salary para melhorar performance de consultas"
                    },
                    new CommandInfo
                    {
                        Name = "SELECT * FROM user_tables;",
                        Description = "Lista todas as tabelas criadas pelo usuário conectado"
                    },
                    new CommandInfo
                    {
                        Name = "SELECT table_name FROM all_tables WHERE owner = 'HR';",
                        Description = "Lista todas as tabelas pertencentes ao schema HR"
                    }
                }
            },
            new ToolArg
